...
/** 将菜单数据转换可渲染数据 */
export function arr2menu(arr: any[]): IAsideMenu[] {
  ...
  /** 转移到上级菜单 top 中 */
  function transferTopMenu(menus: Array<any | null>, topMenu: IAsideMenu) {
    /** 递归出口 */
...
/** 转换为菜单项数据 */
function transformMenuItem(item: any): IAsideMenu {
